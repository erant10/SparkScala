...
object PopularMoviesNicer {
  ...
  val moviesDataPath: String = getClass.getResource("/ml-100k/u.data").getPath
  val itemsDataPath: String = getClass.getResource("/ml-100k/u.item").getPath
  ...
  def loadMovieNames() : Map[Int, String] = {
    ...
    val sc = Source.fromFile(itemsDataPath)
  ...
  def main(args: Array[String]) {
    ...
    val lines = sc.textFile(moviesDataPath)
